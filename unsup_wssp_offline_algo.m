function [I, dm] = unsup_wssp_offline_algo(m,m_idx,k,log_s,weight_sq,varargin)
        ...
        if nargin > 5
            ...
            for i = 2:N
                for j = 1:(i-1)
                    ...
                    dm(i,j) = distance_time_series(m(i,com_obs_ind),m(j,com_obs_ind),'cov',log_s,weight_sq);
                    dm(j,i) = dm(i,j);
                end
            end
        end
